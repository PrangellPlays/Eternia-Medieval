package dev.prangellplays.eternia.item.godweapons.tier2.jungle;
...
public class PhoenixSwordItem extends SwordItem {
    public PhoenixSwordItem(ToolMaterial toolMaterial, int attackDamage, float attackSpeed, Settings settings) {
