...
public class CowSpawnItem extends Item {
    public CowSpawnItem(Settings settings) {
        super(settings);
    }

    @Override
    public TypedActionResult<ItemStack> use(World world, PlayerEntity user, Hand hand) {
        Entity entity = ((EntityType<Entity>) EntityType.get("minecraft:cow").get()).create(world);
