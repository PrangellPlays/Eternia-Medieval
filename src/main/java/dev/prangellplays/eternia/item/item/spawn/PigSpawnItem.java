...
public class PigSpawnItem extends Item {
    public PigSpawnItem(Settings settings) {
        super(settings);
    }

    @Override
    public TypedActionResult<ItemStack> use(World world, PlayerEntity user, Hand hand) {
        Entity entity = ((EntityType<Entity>) EntityType.get("minecraft:pig").get()).create(world);
