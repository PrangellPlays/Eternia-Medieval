...
public class WeaponPedestalRenderer implements BlockEntityRenderer<WeaponPedestalBlockEntity> {
    public WeaponPedestalRenderer(BlockEntityRendererFactory.Context context) {
    }

    private static final Vec3d ITEM_POS = new Vec3d(0.5, 1.5, 0.5);

    @Override
    public void render(WeaponPedestalBlockEntity pedestalBlockEntity, float tickDelta, MatrixStack matrices, VertexConsumerProvider vertexConsumers, int light, int overlay) {
